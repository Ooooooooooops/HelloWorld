...
public class TestVisitorDAO {
	...
	public void testInsertData() {
		 ...
		 */		
		visitor.setUserName("Ahamad");
		visitor.setPassword("password");
		visitor.setFirstName("Ahamad");
		visitor.setLastName("Basha");
		visitor.setEmail("ahamad@email.com");
		visitor.setPhoneNumber("9492066756");
		visitor.setAddress(null);
		try {
				visitorDAO.insertData(visitor);
				visitor=visitorDAO.searchUser("Ahamad", "password");
		...
		assertEquals("Ahamad",visitor.getUserName());
	...
	public void testRegisterVisitorToEvent() {
		...
		try {
			...
			for (Object[] object : registeredEvents) {
				if((Integer) object[0]==1001)
					found=true;
			}
		} catch (ClassNotFoundException e) {
			// TODO Auto-generated catch block
	...
	public void testRegisteredEvents() {
		...
		assertEquals(10, registeredEvents.size());
